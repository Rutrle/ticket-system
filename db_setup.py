...
users.append(User(username='User1',creation_time =datetime.now(), email='user1@mail.com',password='password'))
users.append(User(username='User2',creation_time =datetime.now(), email='user2@mail.com',password='password2'))
tickets.append(Ticket(subject='Something broke',issue_description = "something has broken, it's not my fault",creation_time =datetime.now(),is_solved=False))
tickets.append(Ticket(subject='Something else broke',issue_description = long_text,creation_time =datetime.now(),is_solved=False))
tickets.append(Ticket(subject='lorem ipsum',issue_description = longer_text,creation_time =datetime.now(),is_solved=False))
